...
EMAIL_HOST = 'smtp.gmail.com'  # Host del servidor SMTP de gmail
EMAIL_PORT = 587  # Puerto del servidor SMTP de gmail
EMAIL_USE_TLS = True  # Usar TLS para la conexión segura con el servidor SMTP de gmail
EMAIL_HOST_USER = '#'  # Tu dirección de correo electrónico 
EMAIL_HOST_PASSWORD = '#'  # Contraseña de tu correo electrónico


DEFAULT_FROM_EMAIL = 'arielmarchioni1@gmail.com'
